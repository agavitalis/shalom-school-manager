          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Complete list of students according to their current class</h3>
              </div>
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Complete students list based on class</h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                     Here are your students in each class ).
                    </p>
               ...
               <div class="col-md-4 col-xs-12">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left input_mask" action="/tutor/generalclasslist" method="post">
                            {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-4 col-xs-12"> Class(es)<span class="required">*</span></label>
