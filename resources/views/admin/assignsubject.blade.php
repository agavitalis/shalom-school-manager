            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12 col-md-offset-2">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form class="form-horizontal form-label-left input_mask" action="/admin/assignsubject"
                                method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Subject to assign<span
                                            class="required">*</span></label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Make Coordinator?<span
                                            class="required">*</span></label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <p>
                                            Yes:
                                            <input type="radio" class="flat" name="coordinator" id="genderM"
                                                value="1" required />
                                            No:
                                            <input type="radio" class="flat" name="coordinator" id="genderF"
