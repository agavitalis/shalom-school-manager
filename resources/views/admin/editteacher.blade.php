          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i>teacher Profile Update</h2>
                    <ul class="nav navbar-right panel_toolbox">
                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                               <form  method="post" action="/admin/editteacher/{{$update->id}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                  {{csrf_field()}}
                            ...
                            <form  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="first-name"  value="{{$teacher->email}}" required="required" disabled="true" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                               <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="first-name"  value="{{$teacher->phone}}" required="required" disabled="true" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                               <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="first-name"  value="{{$teacher->date_of_birth}}" required="required" disabled="true" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                               <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <textarea class="form-control" rows="3"disabled="true" placeholder="{{$teacher->address}}">{{$teacher->address}}</textarea>
                                </div>
                              </div>
                              <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="first-name"  value="{{$teacher->lga}}" required="required" disabled="true" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="first-name"  value="{{$teacher->state}}" required="required" disabled="true" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" id="first-name"  value="{{$teacher->country}}" required="required" disabled="true" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
