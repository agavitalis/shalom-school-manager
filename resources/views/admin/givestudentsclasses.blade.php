            ...
            <div class="row">
              <div class="col-md-8">
                  ...
                  <div class="x_content">
                    ...
                    <div class="ln_solid"></div>
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success">Assign selected students this Class</button>
                            </div>
                        </div>
                  </div>
                  </form>
               ...
               <div class="col-md-4 col-xs-12">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left input_mask" action="/admin/givestudentsclasses" method="post">
                            {{csrf_field()}}
