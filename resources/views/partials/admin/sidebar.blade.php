...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-money"></i>Fees Setup<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="/admin/createFees">Create Fees</a></li>
                    <li><a href="/admin/manageFees">Manage Fees</a></li>
                </ul>
            </li>
